...
def parse_maze():
    parser = argparse.ArgumentParser(description='TASRL-RL Victim Arguments')
    ...
    #=======================SAC======================================================
    parser.add_argument('--saved_model_path', default='/Trained_Models/Victim/Jul-28-2022_03_41_AM_SAC_maze_Gaussian/victim_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_-0.0', help='exterior log directory')
...
def parse_nav1():
    ...
    parser.add_argument('--model_path', default='None', help='Loaded model dir')
    #=======================SAC======================================================
    parser.add_argument('--saved_model_path', default='/Trained_Models/Victim/Jul-29-2022_04_30_AM_SAC_nav1_Gaussian/victim_agent/Agent_model/Best_Agent_Model/DateTime_Jul-29-2022_reward_-6.207633963897395', help='exterior log directory')
...
def parse_nav2():
    ...
    parser.add_argument('--model_path', default='None', help='Loaded model dir')
    #=======================SAC======================================================
    parser.add_argument('--saved_model_path', default='/Trained_Models/Victim/Jul-27-2022_21_56_PM_SAC_nav2_Gaussian/victim_agent/Agent_model/Best_Agent_Model/DateTime_Jul-27-2022_reward_-6.407141558867541', help='exterior log directory')
    parser.add_argument('--hidden_size', type=int, default=512, help='hidden size (default: 256)')
    #=========================================================================================================
    parser.add_argument('--gamma',type=float,default=0.99,help='discount factor for reward (default: 0.99)')
    parser.add_argument( '--tau',type=float,default=0.005, help='target smoothing coefficient(τ) (default: 0.005)')
