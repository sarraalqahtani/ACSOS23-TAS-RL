...
def parse_maze():
    parser = argparse.ArgumentParser(description='TAS-RL Adversary Arguments')
    ...
    parser.add_argument('--saved_model_path', default='/Trained_Models/Adversary/Jul-28-2022_02_55_AM_SAC_maze_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_1.0', help='exterior log directory')
...
def parse_nav1():
    ...
    #===============================================================
    parser.add_argument('--hidden_size', type=int, default=512, help='hidden size (default: 256)')
    parser.add_argument('--saved_model_path', default='/Trained_Models/Adversary/Jul-28-2022_21_11_PM_SAC_nav1_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_1.0', help='exterior log directory')
...
def parse_nav2():
    ...
    #===============================================================
    parser.add_argument('--hidden_size', type=int, default=512, help='hidden size (default: 256)')
    parser.add_argument('--saved_model_path', default='/Trained_Models/Adversary/Jul-27-2022_21_38_PM_SAC_nav2_Gaussian/adversary_agent/Agent_model/Best_Agent_Model/DateTime_Jul-27-2022_reward_1.0', help='exterior log directory')
