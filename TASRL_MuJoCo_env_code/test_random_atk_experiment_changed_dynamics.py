...
def run(env_name=None, eval_epi_no=100, rate=1.0):
  ...
  logdir = ' '
  exp_atk_name = 'random/dynamic_change'
  #====================================================================
  ...
  TAS_RL_data_path = os.path.join(expdata_path, env_name, exp_atk_name, str(rate),'TAS_RL', 'random_atk','Changed_dynamics','shield_threshold_{}'.format(shield_threshold))
  #====================================================================
  for eps in epsilon_list:
        ...
        RecRLexp_data_path = os.path.join(expdata_path, env_name, exp_atk_name, str(rate), 'RecRL', 'random_atk','Changed_dynamics')
        ...
        #**********************************************************************************************************
  atk_name = 'random'
  plot_path = os.path.join(expdata_path, env_name, 'Plots', exp_atk_name+'_'+str(rate))
  get_result_data(env_name, TAS_RL_data_path, RecRLexp_data_path, plot_path)
