...
#   print(rate)
  ...
  logdir = ' '
  exp_atk_name = 'aaa/dynamic_change'
  #====================================================================
  ...
  TAS_RL_data_path = os.path.join(expdata_path, env_name, exp_atk_name, str(rate), 'TAS_RL', 'aaa_atk','shield_threshold_{}'.format(shield_threshold))
  #====================================================================
  for eps in epsilon_list:
        ...
        RecRLexp_data_path = os.path.join(expdata_path, env_name, exp_atk_name,str(rate), 'RecRL', 'aaa_atk')
