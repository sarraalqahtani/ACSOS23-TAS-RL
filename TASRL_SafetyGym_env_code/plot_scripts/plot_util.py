...
def plot_step_count(atk_rate, 
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.3), fontsize=20, fancybox=True, shadow=True, ncol=4)
...
def plot_reward_result(atk_rate,
    ...
    trpo_tasrl_reward_sfty_ub = get_specific_list(trpo_tasrl_reward_vec,2)
    trpo_tasrl_reward_sfty_lb = get_specific_list(trpo_tasrl_reward_vec,1)
    trpo_tasrl_reward_sfty_mean = get_specific_list(trpo_tasrl_reward_vec,0)
    axs.fill_between(atk_rate, trpo_tasrl_reward_sfty_ub, trpo_tasrl_reward_sfty_lb, color='cyan', alpha=.5, label='TAS-RL+TRPO Reward')
    axs.plot(atk_rate, trpo_tasrl_reward_sfty_mean, color='cyan', linewidth='2')
    ...
    cpo_tasrl_reward_sfty_ub = get_specific_list(cpo_tasrl_reward_vec,2)
    cpo_tasrl_reward_sfty_lb = get_specific_list(cpo_tasrl_reward_vec,1)
    cpo_tasrl_reward_sfty_mean = get_specific_list(cpo_tasrl_reward_vec,0)
    axs.fill_between(atk_rate, cpo_tasrl_reward_sfty_ub, cpo_tasrl_reward_sfty_lb, color='orange', alpha=.5, label='TAS-RL+CPO Reward')
    axs.plot(atk_rate, cpo_tasrl_reward_sfty_mean, color='orange', linewidth='2')
    ...
    axs.legend(loc='upper center', bbox_to_anchor=(0.5, -0.3), fontsize=20, fancybox=True, shadow=True, ncol=4)
...
def plot_cost_result(atk_rate, 
    ...
    trpo_tasrl_cost_sfty_ub = get_specific_list(trpo_tasrl_cost_vec,2)
    trpo_tasrl_cost_sfty_lb = get_specific_list(trpo_tasrl_cost_vec,1)
    trpo_tasrl_cost_sfty_mean = get_specific_list(trpo_tasrl_cost_vec,0)
    axs.fill_between(atk_rate, trpo_tasrl_cost_sfty_ub, trpo_tasrl_cost_sfty_lb, color='cyan', alpha=.5, label='TAS-RL+TRPO Cost')
    axs.plot(atk_rate, trpo_tasrl_cost_sfty_mean, color='cyan', linewidth='2')
    ...
    cpo_tasrl_cost_sfty_ub = get_specific_list(cpo_tasrl_cost_vec,2)
    cpo_tasrl_cost_sfty_lb = get_specific_list(cpo_tasrl_cost_vec,1)
    cpo_tasrl_cost_sfty_mean = get_specific_list(cpo_tasrl_cost_vec,0)
    axs.fill_between(atk_rate, cpo_tasrl_cost_sfty_ub, cpo_tasrl_cost_sfty_lb, color='orange', alpha=.5, label='TAS-RL+CPO Cost')
    axs.plot(atk_rate, cpo_tasrl_cost_sfty_mean, color='orange', linewidth='2')
    ...
    axs.legend(loc='upper center', bbox_to_anchor=(0.5, -0.2), fontsize=20, fancybox=True, shadow=True, ncol=4)
